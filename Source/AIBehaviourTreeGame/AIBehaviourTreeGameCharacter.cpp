...
bool AAIBehaviourTreeGameCharacter::bHasSpecialBall = false;
...
void AAIBehaviourTreeGameCharacter::Tick(float DeltaTime)
{
...
void AAIBehaviourTreeGameCharacter::AttachSpecialBall()
{
	...
	{
		if (SpecialBall[i]->GetDistanceTo(GetWorld()->GetFirstPlayerController()->GetPawn()) <= 10.0f)
		{
			UE_LOG(LogTemp, Warning, TEXT("SpecialBall Attached"));

			
			SpecialBall[i]->AttachToComponent(GetWorld()->GetFirstPlayerController()->GetPawn()->GetRootComponent(),
				FAttachmentTransformRules::SnapToTargetNotIncludingScale,
				FName("PelvisSocket"));
			bHasSpecialBall = true;
		}
	}
}

bool AAIBehaviourTreeGameCharacter::GetSpecialBallBool()
{
	return bHasSpecialBall;
	
}

void AAIBehaviourTreeGameCharacter::SetSpecialBallBool(bool SpecialBallBool)
{
	bHasSpecialBall = SpecialBallBool;
}
